...
import { useBorginCartStore } from "@/lib/cartStore";
...
export default function BorginBurkesPage() {
  ...
  const { items, addItem, removeItem, clearCart, toggleCart, isOpen, getTotal, getCount } = useBorginCartStore();
  ...
  }, [activeTab, refreshProducts, refreshPurchases]);
