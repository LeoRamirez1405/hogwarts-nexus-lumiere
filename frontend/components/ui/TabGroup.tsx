      ...
      {tabs.map((tab, idx) => {
        ...
        return (
          <button
            ...
            className={`inline-flex items-center gap-2 rounded-full px-6 py-2 text-body-md font-medium transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 ${
