...
def upgrade() -> None:
    ...
    op.bulk_insert(
        ...
        [
            ...
            {"id": "b0000000-0000-0000-0000-000000000006", "name": "Pelota de Cuero de Dragón", "description": "Resistente y rebota alto; ideal para bestias energeticas.", "kind": "toy", "pet_type": "Bestias", "price": 55, "restore_amount": 15, "pack_size": 1, "image_url": None, "created_at": NOW},
