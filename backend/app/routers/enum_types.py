...
@router.post("/categories", response_model=EnumCategoryResponse, status_code=status.HTTP_201_CREATED)
...
@router.post("/categories/{category_id}/values", response_model=EnumValueResponse, status_code=status.HTTP_201_CREATED)
